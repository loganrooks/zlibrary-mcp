#!/usr/bin/env python3
"""
Extract pages 64-65 from Kant's Critique of Pure Reason for multi-page footnote testing.

This script creates a test fixture for validating multi-page footnote continuation.
"""
...
def main():
    ...
    # Note: PDF page 64 = index 63, PDF page 65 = index 64
    pages_to_extract = [63, 64]  # Pages 64-65 in PDF
    ...
    print(f"Extracting pages: {[p+1 for p in pages_to_extract]}\n")
