...
class TestFontSizeCalculation:
    ...
    def test_mixed_text_types(self):
        ...
        assert result == 9.0, (
            "Median should ignore outliers (header 18pt, footnote 6pt)"
        )
...
class TestSuperscriptIntegration:
    ...
    def test_kant_pdf_marker_detection(self):
        ...
        assert len(numeric_markers) > 0, "Should detect numeric markers in Kant PDF"
...
class TestPerformance:
    ...
    def test_font_size_calculation_performance(self):
        ...
        blocks = [
            {
                "type": 0,
                "lines": [{"spans": [{"size": 9.0 + (i % 3)} for i in range(100)]}],
            }
        ]
